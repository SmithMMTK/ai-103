...
| Processing Location   | Pay per Token      | Reserved PTU          | Cheap Async     |
| --------------------- | ------------------ | --------------------- | --------------- |
| **Global**            | Global Standard    | Global Provisioned    | Global Batch    |
| **Data Zone (EU/US)** | Data Zone Standard | Data Zone Provisioned | Data Zone Batch |
| **Regional**          | Standard           | Regional Provisioned  | N/A             |
| **Special**           | Developer          | -                     | -               |
